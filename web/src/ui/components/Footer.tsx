...
const Footer = () => {
  return (
    <div className="z-[100000] flex w-full flex-col items-center justify-between gap-5 border-t border-gray-900/5 px-10 py-8 backdrop-blur-md backdrop-filter sm:flex-row dark:border-white/5">
